...
import { type ColumnDef, getCoreRowModel, getFilteredRowModel, getSortedRowModel, useReactTable, flexRender, type SortingState, type VisibilityState, type ColumnFiltersState, } from "@tanstack/react-table";
                ...
                <div className="flex items-center gap-2 flex-wrap flex-1">
                    {showSearch && (
                        <Input
                            ...
                            value={searchTerm}
                            disabled={isLoading}
                            onChange={(e: { target: { value: string; }; }) => handleSearch(e.target.value)}  // any
                            className="max-w-sm"
                        />
                    )}
                    {filters.map(({ key, label, options }) => (
                        <Select
                            ...
                            disabled={isLoading}
                            onValueChange={(value: string) => handleFilterChange(key, value)}
                        >
